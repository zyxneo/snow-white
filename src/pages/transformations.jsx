            ...
            <ScrollSection onEnter={this.onEnterViewport} id="story.transformations.coffin">
              ...
              <div>
                ...
                <p style={{ display: 'grid', gridTemplateColumns: '1fr 2fr', columnGap: '10px' }}>
                  <img className="ui fluid image" src={withPrefix('images/snowwhite/coffin/matrix/fgpvy.jpg')} />
                  <img className="ui fluid image" src={withPrefix('images/snowwhite/coffin/matrix/the-matrix-power-plant-bodies.jpg')} />
                </p>
              </div>
            </ScrollSection>
