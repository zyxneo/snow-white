        ...
        <div className="content">
          <div className="ui text container list">
            <ScrollSection onEnter={this.onEnterViewport} id="story.textil">
              ...
              <h3>Ruházkodás</h3>
              <div>
                <img src={withPrefix('images/queen/window/a65f177970483dd5ef1a461c114e91ad.jpg')} className="ui medium left floated image" />
            ...
            <ScrollSection onEnter={this.onEnterViewport} id="story.textil.fates">
              <h3>Párkák, Moirák</h3>
              <div>
                <img src={withPrefix('images/fates/a25405d1141943b4edd85761a57259ac.jpg')} className="ui medium left floated image" />
                <p>A moirák a végzet irányítói, az emberi élet fonalát szövő, gombolyító illetve elvágó három istennő a görög mitológiában. A Párkák a görög mitológiából ismert Moirák római megfelelői; sorsistennők, akik fonják, kimérik, majd elvágják az ember életfonalát. Hatalmukban áll megakadályozni az istenek akaratának érvényesülését is. Nona (a görög mitológiában Klóthó) az emberi élet fonalát fonja, Decima (Lakheszisz) ereszti hozzá a szöszt, és végül Morta (Atroposz) vágja el a fonalat. Méltóságteli nőalakokként ábrázolják őket.</p>
                <img src={withPrefix('images/fates/three-witches/d4710ee9fae272eee45c2f3becbc080f.jpg')} className="ui fluid image" />
                <p className="padded">William Shakespeare Macbeth című regénében három boszorka formájában jelennek meg.</p>

                <div className="masonry">
                  <img src={withPrefix('images/fates/three-witches/9e2a97f84100ee5730b7c83e20c4c4f1.jpg')} />
                  <img src={withPrefix('images/fates/three-witches/c263e696ad1357d2d1cf204c69dac4ed.jpg')} />
                  <img src={withPrefix('images/fates/three-witches/9a2a4667e945cdf3fac3d08dfac9f6e5.jpg')} />
                  <img src={withPrefix('images/fates/three-witches/5ccb1a03af315c96f9cb0546ef516fc9.jpg')} />
                  <img src={withPrefix('images/fates/db5a5f9de64767f008440645fe946191.jpg')} />
                  <img src={withPrefix('images/fates/three-witches/de7de374e73267d2c51d39c2f0c665fa.jpg')} />
                </div>
                ...
                <img src={withPrefix('images/fates/thread-of-life/e060710ee49c97f5e15f0107682903b3.jpg')} className="ui fluid image" />
                ...
                <p>
                  <img src={withPrefix('images/fates/three-witches/507b2de3fd7820d7635379419b461e44.jpg')} className="ui fluid image" />
                  <img src={withPrefix('images/fates/thread-of-life/37beef605e6b1147dda91067b37373a5.jpg')} className="ui fluid image" />
                  <img src={withPrefix('images/fates/thread-of-life/ffa194d2f308ee1ca1d4460730df9bdc.jpg')} className="ui fluid image" />
                </p>
              </div>
            </ScrollSection>

            <ScrollSection onEnter={this.onEnterViewport} id=".story.textil.dna">
              <h3>DNS</h3>
              <div>
                <img src={withPrefix('images/dns/a32918ec5f7922be423e6ef0cffbdc7b.jpg')} className="ui medium left floated image" />
                <p>Kettős spirál ami az élet kialakításához szükséges információt hordozza. Egyetlen sejtben (a megtermékenyült petében) a sejtmagon belül a teljes kifejlett szervezet felépítéséhez szükséges teljes információmennyiség benne van. Ráadásul képes a változó környezetre reagálni, alkalmazkodni. Egy fonat, mely időről időre összehúzódik és kitárul. Összegubancolódik vagy „kiegyenesedik“. Olykor tárolási üzemmódban van, megmerevedik, védekezik, olykor olvasásiban, ilyenkor ellágyul, működésbe lép, kibontja szerkezetét. (Nem pont ilyen minden mese is?)</p>
                <p>A DNS szála tehát a természet által írt mese, egy olyan fonal, amire az élet meséje van írva. Ez mindannyiunkban benne rejlik, akaratunktól függetlenül zajlik írása, olvasása.</p>
                <p>
                  <img src={withPrefix('images/dns/1e128f17a2754dbaacc515b9883f9bd1.jpg')} className="ui fluid image" />
                  <img src={withPrefix('images/dns/jf14.reviews.prenatal.large.jpg')} className="ui fluid image" />
                  <img src={withPrefix('images/dns/457f1b1e41a030e3210130a7bc1c53eb.jpg')} className="ui fluid image" />
                  <img src={withPrefix('images/dns/f21f2b158b9197d88ab7e612a0e75f7b.jpg')} className="ui fluid image" />
                </p>
              </div>
              ...
              <div>
                ...
                <p className="masonry">
                  <img src={withPrefix('images/dns/matrjoska/019652849fd22db5f0088af040962781.jpg')} />
                  <img src={withPrefix('images/dns/matrjoska/3880be7de644038d7cfb468b6a747d00.jpg')} />
                  <img src={withPrefix('images/dns/matrjoska/0_f546b_588af444_orig.jpg')} />
                  <img src={withPrefix('images/dns/matrjoska/a13b3422c1cbc19413a7dfecd5958f7a.jpg')} />
                  <img src={withPrefix('images/dns/matrjoska/dbebe4312c34d5cfa7c8d4149d024098.jpg')} />
                  <img src={withPrefix('images/dns/matrjoska/b58489aba261b35eb8ad0d6279d57192.jpg')} />
                  <img src={withPrefix('images/dns/matrjoska/1e1cf6035e3249360c99559e50ef6a0a.jpg')} />
                  <img src={withPrefix('images/dns/matrjoska/927fb907e09d87f9a6bd0900e42c9180.jpg')} />
                </p>
                ...
                <div className="masonry">
                  <img src={withPrefix('images/dns/32de5807acc475392c15cbc49af42f35.jpg')} />
                </div>
              </div>
              ...
              <div>
                ...
                <div className="masonry">
                  <img src={withPrefix('images/color/redInWhite/b83c400a44b7d142921f5ffbba763a55.jpg')} />
                  <img src={withPrefix('images/fates/thread-of-life/9c09b54f0da13c1c6d1356ad0de52caa.jpg')} />
                  <img src={withPrefix('images/fates/thread-of-life/35cd5c983767e2c2a59e4c4c77cb1c77.jpg')} />
                  <img src={withPrefix('images/fates/thread-of-life/040e6d26e4dbb46e24a9c9617e8974f5.jpg')} />
                  <img src={withPrefix('images/fates/thread-of-life/64f6ea975d4b314146e44192d9673050.jpg')} />
                  <img src={withPrefix('images/dns/c7c78680bfdecaf2ccc3a68462b9a9bf.jpg')} />
                  <img src={withPrefix('images/fates/thread-of-life/aed82a3172e89ffe7342e60fd1530bd3.jpg')} />
                  <img src={withPrefix('images/fates/thread-of-life/207d9bd9993794c272a3476789a7b58f.jpg')} />
                  <img src={withPrefix('images/fates/thread-of-life/b1578388008fbad81642dc3ac59dc15a.jpg')} />
                  <img src={withPrefix('images/fates/thread-of-life/a2c850a98410f3012e82d9c72c75098b.jpg')} />
                </div>
              </div>
            </ScrollSection>

            <ScrollSection onEnter={this.onEnterViewport} id=".story.textil.tissue">
              <h3>Szövettan, avagy varrodai leletek</h3>
              <div>
                <p>Németül a varrás: <i>nähen</i>, a közelben: <i>in der Nähe</i>. Magyarul a var hegesedő sebet jelent. A varrás ősi, tágabb értelmű vagy rokonító jelentése szerintem a nyílt rész összehúzása, vágat, seb sebződése, annak gyógyulása összeforradással, közeli, összetartozó élek közelítése, összeolvadása, összehúzódása. A sebészetben a sebet tűvel, cérnával varrják össze, majd az magától varasodik. A belsőszervek nem varasodnak, csak a bőrfelszín, a var szó rokonítható a bőr szóval (Czuczor-Fogarasi szótár). A bőr ugyanúgy fedi be a testet, mint a ruházat, amit nem véletlenül hívnak „második bőr“-nek.</p>


                <p>A ruhaneműk életciklusában három fontos varrást különböztetnék meg:</p>
                <ol>
                  <li>Szabás-varrás: a méteráru vágása, és összeillesztése. A különböző módon szőtt szöveteket formára vágják, és összevarrják, így hozva létre kezeslábas, emberforma ruhákat. Ez a teremtés szintjén az emberi alakzat létrejötte, annak „megformálása agyagból“ vagy más anyagból.</li>
                  <li>Hímzés: a textília díszítése tűvel, cérnával. A hímzés során szép minták kerülnek a ruha színére, míg a fonáka általában elhanyagoltabb marad, az elkötések miatt. A szín-fonák páros mutatja, hogy a magyar nyelv a fel<i>színt</i> eleve színesnek fogja fel. Az emberi alakzat egyediségét, minőségét jelzi, de akár párhuzamot lehetne vonni azzal, amikor az Isten lelket lehel az agyagfigurába.</li>
                ...
                <p>A varrás folyamata így hasonlóvá tehető és beilleszthető a fonás és szövés alkotói folyamatok sorába, amely elvont értelemben az élőlény szöveteit hozza létre és élteti. A varrás e szerint jobban köthető a már meglévő, kibontakozott élethez, míg a fonás ennél is elvontabb, mélyebb, tágabb értelmű szimbólum.</p>
                <p>Ahogy a szervezet felépítésének szintjeit tagolva eljutunk a szerveken, <i>szöveteken</i>, sejteken át az örökítő anyag egyedi (titkos) információjáig, úgy bonthatjuk az egyedi textil szövetét mint szimbólumot kézzel fogható ismeretektől a sejtésen át az általános létezés örök titkáig.</p>
                <p>
                  <img src={withPrefix('images/dns/cb6b01d8a7e3fa5a827663e0b466da45.jpg')} className="ui fluid image" />
                </p>
