          ...
          <div className="ui text container list">
            <ScrollSection onEnter={this.onEnterViewport} id="story.terminal">
              ...
              <div>
                ...
                <p className="masonry">
                  <img src={withPrefix('images/cpu/44ddd83ba52d9ec99ce470e7f03f272b.jpg')} />
                  <img src={withPrefix('images/cpu/c6eb264a9386228a470f7e67ce873a82.jpg')} />
                  <img src={withPrefix('images/cpu/cc1c0869ec80fa17ab57410c763e8108.jpg')} />
                </p>
            ...
            <ScrollSection onEnter={this.onEnterViewport} id=".story.terminal.spindle">
              <h3>Fonás</h3>
              <div>
                ...
                <ul>
                  ...
                  <li>Lumpenstikli (Rumpelstilzchen) a szalmából is aranyat tud fonni. A magyar megfelelője ennek a mesének a kaponyányi manó. A rumpelstilz - mángorrúd mintájaként eredeti neve a „kapanyélnyi monyú“ etikai okokból nem kerül be a gyermek-mesekönyvekbe. (Kapanyányi Monyó - Kapanyélnyi monyú manó)</li>
                ...
                <p className="masonry">
                  <img src={withPrefix('images/fairytales/9310794dda3cbe1fc101108c2b9d2040.jpg')} />
                  <img src={withPrefix('images/fairytales/13f71b06d0e2bca27549ed6ed7892fab.jpg')} />
                  <img src={withPrefix('images/fairytales/aab0667a3ef2d4b3cbdd7957b8759c7f.jpg')} />
                  <img src={withPrefix('images/fairytales/2096352872310edbff0dc3fd7a0d86ea.jpg')} />
                  <img src={withPrefix('images/fairytales/d40552a519574f7fbed1ea72d1d0e928.jpg')} />
                  <img src={withPrefix('images/fairytales/e1fda19e8a537dff40a9d0d33322d8f8.jpg')} />
                </p>
              </div>
            </ScrollSection>
