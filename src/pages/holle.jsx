          ...
          <div className="ui text container list">
            <ScrollSection onEnter={this.onEnterViewport} id="story.fairytales.holle">
              ...
              <div>
                ...
                <p>Ha tovább manipulálom a nevet, még a hivatalos levezetés is kijön: Heilig, Holy, azaz szent. A különbség ellenére szeretném nyomatékosítani, a téma és a kontextus azonos. Egy közös európai történetről van szó, akár egyetemesnek is mondhatjuk.</p>
                ...
                <blockquote>
                  <p>Azzal kézen fogta, és egy nagy kapuhoz vezette.</p>
                  <p>- Innét most már mehetsz magad is - mondta -, ez a kapu egyenest a falutok határába nyílik.</p>
