module.exports = {
  ...
  'story.textil.fates.title': 'Párkák',
  'story.textil.fates.desc': 'A három ősi boszorka az élet fonalát sodorja. Az egyik a szöszt adja, a másik sodorja, a harmadik a fonalat elvgja Gubanc, tekervény, sodrat, fonal, szövet, textil...  Az ablaknál fonó királynő előrevetíti a jövő történéseit: hófehérke “gubancba” keveredik, az élet messzire “sodorja”. Ebben a kon”textus”ban a királynő egy párka, ábrándokat “sző”. A mostoha “fon”dorlatos, a történet “fonala” “tekervényes”.',

  'story.textil.dna.title': 'DNS',
  'story.textil.dna.desc': 'Kettős spirál ami az élet kialakításához szükséges információt hordozza. Egyetlen sejtben (megtermékenyült pete) a sejtmagon belül a teljes kifejlett szervezet felépítéséher szükséges teljes információmennyiség benne van. + képes a változó környezetre reagálni. Egy fonat, mely időről időre összehúzódik és kitárul. Összegubancolódik vagy “kiegyenesedik”. Olykor tárolási üzemmódban van, megmerevedik, védekezik, olykor olvasásiban, ilyenkor ellágyul, működésbe lép, kibontja szerkezetét.',
