module.exports = {
  ...
  'character.queen.title': 'Királynő',
  'character.snowwhite.title': 'Hófehérke',
  'character.stepmother.title': 'Mostoha',
  'character.king.title': 'Király',
  'character.prince.title': 'Herceg',
  'character.huntsman.title': 'Vadász',
  ...
  'story.scene.beginning.witch': 'A királyné meghalt, helyét a gonosz mostoha vette át. Ez a nő pont az ellentéte volt a királynőnek, ezért nemigen szeretjük.',
  'story.scene.beginning.huntsman': 'A gonosz mostoha felbérli a vadászt, hogy ölje meg Hófehérkét. A vadász kivételt tesz, megszegve ezzel munkaköri kötelességét.',
  'story.scene.beginning.prince': 'Hófehérke elmenekül, jön a törpés jelenet, aztán meg a herceg. A herceg kiszabadítja Hófehérkét a gonosz törpék közül, és frigyre kelnek.',
