...
const Section = props => (
  <React.Fragment>
    <ScrollSection {...props} id="story.fairytales.theseus">
      <h3>Thezeus</h3>
      <div>
        <p>Érdemesnek tartom megemlíteni Thezeus történetét, ami Grimm gyűjtés formájában is fennmaradt. Thezeus megkűzd a félig bika, félig ember testű Minotaurusszal a Labyrinthusban. Több alkalommal, több formában is hallottam már a történetet, de az összefüggés a keresztényi kultúrával nem esett le. Pedig igen nyilvánvaló</p>
        ...
        <p>A próbatétel ezúttal a szörny, az Őr-Dög, a Minota-Úr legyőzése. Férfiaknak való feladat, így a Holle anyó a női, mígy Thezeus <b>ugyanannak a belső utazásnak</b> a férfi alternatíváját mutatja be.</p>
        ...
        <p>A Minotaurusz és Csipkerózsika különleges egyvelege a Hercegnő és a kobold történet. Thezeus itt Kóficként jelenik meg, ellenfele pedig Takonypóc, a kobold, aki a bányák alatt a mélységben él. Csipkerózsikára hasonlít Angelika hercegnő, a mese másik főszereplője. A padlásszobában ő is egy fonónőt talál, csakhogy ez a fonó tulajdon öse, jóindulatú, és nem elaltatja, hanem pont hogy felébreszti a lányt. A misztikus nagymama különleges tudásba avatja be Angelikát, és egy fonalat ajándékoz neki. Ennek segítségével a lány szabadítja ki a sötét mélységben, árnyékszemélyisége fogságában ragadt fiút. Érdekes, hogy a fiú bukásának egyik oka, hogy a szüleitől szerzett fonal nem bizonyul használhatónak akciója során, mikor egymaga indul neki a sötét mélység felderítésének. Kófic és Angelika kapcsolata akkor rendeződik, mikor a fiú megismeri a leány nagymamáját, a misztikus női ősképet.</p>
      </div>
    </ScrollSection>
  </React.Fragment>
)
