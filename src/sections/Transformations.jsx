...
const Section = props => (
  <React.Fragment>
    <ScrollSection {...props} id="story.transformations">
      <h2>Átalakulások</h2>
      <div>
    ...
    <ScrollSection {...props} id="story.transformations.snowwhite">
      <h2>Hófehérke átalakulása - a nő jellemfejlődésének útja</h2>
      <div>
        <p><img src="images/snowwhite/transformation/d08af55c3c132937d429330305423ba4.jpg" className="ui fluid image" /></p>
        ...
        <p className="masonry">
          <img src="images/witch/83c20240358d6259d10ab0e1ec2232cc.jpg" />
          <img src="images/snowwhite/heartless/714f205905464c86268a585d854b080e.jpg" />
          <img src="images/snowwhite/3017b17f75c3d9e3a28481cca638a617.jpg" />
        </p>
      </div>
    </ScrollSection>

    <ScrollSection {...props} id="story.transformations.snowwhite-and-the-death">
      <h3>Hófehérke és a halál</h3>
      <div>
        <p>Noha Hófehérke nem hal meg a mesében, de nagyon közel kerül hozzá. Ennek az oka a gonosz mostoha szándéka, az elveszejtés ötlete az ő fejében fogalmazódik meg. Első alkalommal amikor a mostoha felbújtja a vadászt, az ő keze tiszta marad, és a vadász megtorpanása bizonyítja, hogy nem értett egyet a tervvel, így ez a szándék kizárólag a gonosz mostoha szándéka marad. A mostohára nem kell feltétlenül külső személyként gondolni, lehet ő egy belső árnyékszemélyiség is. Úgy tűnik, a legtöbb nő életében viszonylag fiatalkorban eljön az az időszak, amikor megkapja ezt a belső élhívást, és az erdő felé veszi az utat. A mesékben a nő útja az erdőbe nem sétaként jelenik meg, sokkal inkább mint űzött vad menekül be az erdőbe. Nehéz megfogalmazni, mi is ez az ősi elveszejtő szándék, mi is ez a vágy, avagy félelem, hiszen egy kialakulatlan személyiség bizonytalan, zavart de rendkívül erős érzelmeiről van szó.</p>

        <p className="masonry">
          <img src="images/snowwhite/death/9dbfe66649033c9d2e53cbd43284c9a7.jpg" />
          <img src="images/snowwhite/death/55a92caa159c914ae23ee87c69864d4c.jpg" />
          <img src="images/snowwhite/death/da7cdc9f004da24f8fdec89d97623805.jpg" />
          <img src="images/snowwhite/death/bc045b5b1f5d39829fc6e944efd49661.jpg" />
          <img src="images/snowwhite/death/cc2f60e1c2a3014bb87fe8ae6cf67c8c.jpg" />
          <img src="images/snowwhite/death/f76f12c76135471ebd189c7ce27f82a0.jpg" />
        </p>
    ...
    <ScrollSection {...props} id="story.transformations.coffin">
      <h3>A koporsó</h3>
      <div>
        <p></p>
        <p className="masonry">
          <img src="images/snowwhite/coffin/0f38ed0ae8ad39b83e59543d3f9cf182.jpg" />
          <img src="images/snowwhite/coffin/209a14383420f1fe2c40169046d3ebc0.jpg" />
          <img src="images/snowwhite/coffin/3c6cd48a6d7a018dea5063f0e1842c7a.jpg" />
          <img src="images/snowwhite/coffin/5794221012224ca998d599f95e67ae67.jpg" />
          <img src="images/snowwhite/coffin/1c99cffe99166a58302ece80defc5b8c.jpg" />
          <img src="images/snowwhite/coffin/dc3e999bceb2ae6726e080ad0a7384c2.jpg" />
          <img src="images/snowwhite/coffin/f83ac76f284011172e3d7d932a46ea97.jpg" />
        </p>
        ...
        <p>Az első szín a fehér. A mostoha egy övvel elszorítja Hófehérke derekát, amíg az nem kap levegőt. Ez a szimbólum magyar nyelven a legérthetőbb, hiszen <i>lélek</i> és lélegzet (e: <i>lélekzet</i>) szavaink mutatják, a légzés és a bennünk élő lélek kapcsolatát. Mondjuk is: Kileheli lelkét - azaz meghal - akinek lelke, mint utolsó lélegzet elhagyja testét (melybe lehet, hogy csak hálni járt). A boszorka első támadása a lélek ellen irányul. Nem hiába, hiszen amikor a vadász megpróbálta megülni a lányt, abban volt annyi <i>lélekjelenlét</i>, hogy kérlelni kezdte gyilkosát, vagyis megoldást keresett az adott szituációban. A lányka szava hatott a vadász lelkére is, így futni hagyta a lányt, de előtte <i>lelkére kötötte</i>, hogy sose térjen vissza mostohájához. A boszorka viszont rátalált Hófehérkére, és ott támadta meg, ahol a legsebezhetőbb: a lelkénél. Az első szint a lelki, erkölcsi, hitbéli szint, itt dől el minden. Ennek a funkciónak a kiiktatása elvágja az egyént a spiritualitástól, a transzcendenstől, az istenkapcsolatától, eltéríti azt a fény útjáról, innen a fehér szín.</p>
        <p><img src="images/snowwhite/biancaneve/Biancaneve-28929.jpg" className="ui fluid image" /></p>
        <p>Hófehérke feltámad, s bár a mese nem említi, én hozzáteszem, hogy valamit viszont elvesztett. A mostoha trükkje sikeres volt, és Hófehérke szeme elhomályosodott, nem látja többé önnön lelkét, lélegzése megindult, de a szimbolikus elfojtás mutatja: lelkének működése leállt.</p>
        <p>Nagyszerű, jöhet a második szint, az elme. A mesében a mérgezett fésű utal a fejre, ennek helyére. A haj fésülése szintén nőiségi szimbólum, akár csak a karcsú derék, de emlékezzünk a fekete szín jelentéseire, pl.: tudatlanság, elmezavar. Az agy a koponyában foglal helyet, védett helyen van, viszont abszolút sötétségben. A szellem maga gyújt itt világosságot, már ha gyújt. Ezúttal a mostoha gondoskodott róla, hogy miközben szelíden, kedvesen fésülgette a lány haját, hogy az elaléljon, és ezalatt sötét gondolatokkal mérgezte elméjét.</p>
        <p><img src="images/snowwhite/biancaneve/Biancaneve-281029.jpg" className="ui fluid image" /></p>
        ...
        <p><img src="images/snowwhite/biancaneve/Biancaneve-281129.jpg" className="ui fluid image" /></p>

        <p>Ezúttal az alma szimbólumával a test, pontosabban Hófehérke kibontakozó nőiessége ellen tör.</p>

        <img src="images/snowwhite/biancaneve/Biancaneve-281529.jpg" className="ui small left floated image" />
    ...
    <ScrollSection {...props} id="story.transformations.heartless">
      <h3>A szívtelen</h3>
      <div>
        ...
        <p className="masonry">
          <img src="images/snowwhite/heartless/e138f748be95ecd199467ea4ed8f5220.jpg" />
          <img src="images/snowwhite/heartless/e9b276e7b1ed1f28846e04f84f412858.jpg" />
          <img src="images/snowwhite/heartless/b4c9e8c07e83a23d8b1464548b3afcd7.jpg" />
        </p>
      </div>
    </ScrollSection>
    ...
    <ScrollSection {...props} id="story.transformations.heartless">
      ...
      <div>
        ...
        <p className="masonry">
          <img src="images/witch/witchcraft/867c02d5f5aefb82fa1fb3dccc4dcb95.jpg" />
          <img src="images/witch/witchcraft/670491d9e82ac151b33138cd4d21ca07.jpg" />
          <img src="images/witch/witchcraft/tumblr_mw69d0RUIX1s32irio3_400.jpg" />
        </p>
    ...
    <ScrollSection {...props} id="story.transformations.heartless">
      ...
      <div>
        ...
        <p className="masonry">
          <img src="images/witch/force/df15bf7c503bf9b7710e69a5288cc1ea.jpg" />
          <img src="images/witch/witchcraft/39f8c6109f31fab7ff2780d518c79574.jpg" />
          <img src="images/witch/witchcraft/75d498cb2b05cc9a2766e38849182c96.jpg" />
          <img src="images/witch/witchcraft/b4dc43ec794cb62725352867ec6b3699.jpg" />
          <img src="images/witch/force/6560d4f51e85dbbf393887a2d685f6a6.jpg" />
          <img src="images/witch/force/a779cb089ba00620f5c6a3efa2d17059.jpg" />
          <img src="images/witch/witchcraft/b13cade9ae6106e6539efdc35b7dc3dd.jpg" />
          <img src="images/witch/witchcraft/dd736127c4a3a22645cf37fbf26ee00a.jpg" />
          <img src="images/witch/witchcraft/4b7068d87fb279a30ec32523d19f1d54.jpg" />
        </p>
    ...
    <ScrollSection {...props} id="story.transformations.heartless">
      ...
      <div>
        ...
        <p className="masonry">
          <img src="images/witch/force/fa14c771ff0c9f0ad4036cfcb40c84b0.jpg" />
          <img src="images/witch/force/3f1f7fc8962c90074d1dc3eabe28f6aa.jpg" />
          <img src="images/witch/force/9d29be85323d94386a3a375f386262ea.jpg" />
        </p>
      </div>
    </ScrollSection>
    ...
    <ScrollSection {...props} id="story.transformations.heartless">
      ...
      <div>
        ...
        <p className="masonry">
          <img src="images/witch/witchcraft/9a0e74737279a3c4dfc9c39d99b7ec54.jpg" />
          <img src="images/witch/witchcraft/218ec300f4513fea1b17ca2daf629e76.jpg" />
          <img src="images/witch/force/0ec72b9142a6383141461c9aeae51f60.jpg" />
          <img src="images/witch/force/3816d01ed18685c5b9cde31f83c392c0.jpg" />
          <img src="images/witch/witchcraft/065b8a71b2c1c9c43abcf1075bd188ba.jpg" />
          <img src="images/witch/force/5ff62575b1fb9de0738cc5f12e55d661.jpg" />
        </p>
    ...
    <ScrollSection {...props} id="story.transformations.heartless">
      ...
      <div>
        <p><img src="images/witch/force/chao-huang-qq-20180131153402.jpg" className="ui fluid image" /></p>
    ...
    <ScrollSection {...props} id="story.transformations.heartless">
      ...
      <div>
        <p><img src="images/witch/witchcraft/b3766cc7410fee5754c328d72a63fb85.jpg" className="ui fluid image" /></p>
    ...
    <ScrollSection {...props} id="story.transformations.fate">
      <h3>A párka</h3>
      <div>
        <p></p>
        <p className="masonry">
          <img src="images/queen/fates/87bbd392139ab439c63de878b70cb585.jpg" />
          <img src="images/queen/fates/473e392b5465e101a98a7396c2e99e35.jpg" />
          <img src="images/queen/fates/10baad9779af529bb5b56e701e270601.jpg" />
        </p>
      </div>
    </ScrollSection>

    <ScrollSection {...props} id="story.transformations.prince">
      <h2>A herceg átalakulása - a férfi jellemfejlődésének útja</h2>
      <div>
        <p><img src="images/huntsman/transform/fa2a04d970a14491556259db4ab84051.jpg" className="ui fluid image" /></p>
    ...
    <ScrollSection {...props} id="story.transformations.prince-appears">
      <h3>A herceg felbukkan</h3>
      <div>
        <p><img src="images/prince/a835c5a48f2c5f3fbb26ec4f0c1328d9.jpg" className="ui fluid image" /></p>
    ...
    <ScrollSection {...props} id="story.transformations.fallen-prince">
      ...
      <div>
        ...
        <p className="masonry">
          <img src="images/prince/transform/b17d24ac369c34a0da1da9f6da8749d2.jpg" />
          <img src="images/prince/transform/fdd0b90328b044e66d8d103dcbb6030e.jpg" />
          <img src="images/prince/transform/8daeeb008e81c950466fb7baa29be872.jpg" />
          <img src="images/prince/transform/2297848269164c76b7d7d57dfc948132.jpg" />
          <img src="images/prince/transform/a9e62abe1f07cfc1b5917313e1484a4a.jpg" />
          <img src="images/prince/transform/d1e27a284feb8f5830c260e7139418bf.jpg" />
        </p>
    ...
    <ScrollSection {...props} id="story.transformations.huntsman">
      <h3>A vadász</h3>
      <div>
        ...
        <p className="masonry">
          <img src="images/huntsman/b3a9fe2484194a4707ff955f7df30587.jpg" />
          <img src="images/huntsman/caff303f7d903719630909f238ea8899.jpg" />
          <img src="images/huntsman/e90c121aa020b2faae63ccc50b8ebb0e.jpg" />
          <img src="images/huntsman/ea835ccca4df39a02addb501cb47af44.jpg" />
          <img src="images/huntsman/da029ca1f7bee01f61333f3d42cfc38c.jpg" />
          <img src="images/huntsman/f8aa726249c8adbe60b61349ef0f8818.jpg" />
        </p>
    ...
    <ScrollSection {...props} id="story.transformations.power">
      <h3>Az őserő</h3>
      <div>
        <p></p>
        <p className="masonry">
          <img src="images/king/transformation/0048cbaaf5489bb8b8e7f852e5d73bdf.jpg" />
          <img src="images/huntsman/witchcraft/e7b816ed3ad861cae71b3a1df3bce245.jpg" />
          <img src="images/huntsman/witchcraft/c826841cbbb20078cab3da8ee59f171b.jpg" />
          <img src="images/huntsman/witchcraft/d2c3b80ffa881772adf95e2a245648f3.jpg" />
        </p>
      </div>
    </ScrollSection>

    <ScrollSection {...props} id="story.transformations.intellect">
      <h3>Intellektus</h3>
      <div>
        <p></p>
      </div>
    ...
    <ScrollSection {...props} id="story.transformations.management">
      <h3>Küzdelem - Uralom - Félelem</h3>
      <div>
        <p></p>
        <p className="masonry">
          <img src="images/huntsman/transform/0f0b403c891079d0e994fbedb2e3aa2d.jpg" />
          <img src="images/huntsman/transform/b325ab7aceae9d5895bcfd9be7ee68d1.jpg" />
          <img src="images/huntsman/transform/d8f0f19f061255b3b2260bd293c9e59e.jpg" />
          <img src="images/huntsman/transform/d9d6f8aeecdeb8c55a11de5f28f3a608.jpg" />
          <img src="images/huntsman/transform/7b6b64de4a4d810f1a30f05a7dd06430.jpg" />
          <img src="images/huntsman/transform/08f4287ba09fbc2742e67ae886f1effd.jpg" />
        </p>
      </div>
    </ScrollSection>

    <ScrollSection {...props} id="story.transformations.other-half">
      <h3>A jobbik fél és a rosszabbik, Hófehérke és a vadász</h3>
      <div>
        <p></p>
        <p className="masonry">
          <img src="images/huntsman/transform/d267c62a643154db99635dcd067574f4.jpg" />
          <img src="images/huntsman/transform/19ee7eaadc58e3ccfba06af9eb9d86c3.jpg" />
          <img src="images/huntsman/transform/925c675b37e20345a2e6131eafea4bea.jpg" />
          <img src="images/huntsman/transform/232ead3ade09157c20a874262613a127.jpg" />
          <img src="images/huntsman/huntsman-and-snowwhite/3cfa95f84c5ef0666ecf5e5dd4c9c46c.jpg" />
          <img src="images/huntsman/huntsman-and-snowwhite/4dc208a042867ed446c5060559bf35a6.jpg" />
          <img src="images/huntsman/huntsman-and-snowwhite/5a9dce45bcfec099e66cd04d02f333b2.jpg" />
          <img src="images/huntsman/huntsman-and-snowwhite/075b2ea01438236c2ac2362660ee1cd1.jpg" />
          <img src="images/huntsman/huntsman-and-snowwhite/2814c94ab7c41d903cad66fe0d92996d.jpg" />
          <img src="images/huntsman/huntsman-and-snowwhite/287007fd6a5eef425725ece77d008bcd.jpg" />
          <img src="images/huntsman/huntsman-and-snowwhite/adc16e9e7e057d01668a578bd50f8937.jpg" />
          <img src="images/huntsman/huntsman-and-snowwhite/db321f54244b0f1278297aded6483767.jpg" />
          <img src="images/huntsman/huntsman-and-snowwhite/dbc8a538c2ec79965544d4b8f8548faa.jpg" />
          <img src="images/huntsman/huntsman-and-snowwhite/eca70e4bea0ec69ea592fba52efd3d8b.jpg" />
          <img src="images/huntsman/huntsman-and-snowwhite/f1d428cdb19de2c49d81130f24fc4b4c.jpg" />
          <img src="images/huntsman/huntsman-and-snowwhite/f2b421c44f452504ddcdeb75222beb0d.jpg" />
        </p>
      </div>
    </ScrollSection>

    <ScrollSection {...props} id="story.transformations.fallen-king">
      <h3>A bukott király</h3>
      <div>
        <p></p>
        <p className="masonry">
          <img src="images/king/transformation/3ba3f8e6a8ac28e0a6a1d7d13ed6a122.jpg" />
          <img src="images/king/transformation/551376cf511cc7bbc413f70c6f53f5e8.jpg" />
          <img src="images/king/transformation/32e967f53aa10bfaf8bfd41f0c2ebe83.jpg" />
          <img src="images/king/transformation/a9b341d1dd918457024853a1f857b595.jpg" />
          <img src="images/king/transformation/9e8cbeea5d5c03a3f9a8b82770b09663.jpg" />
          <img src="images/king/transformation/a85250af52f7c0f029d938b864150517.jpg" />
        </p>
      </div>
    </ScrollSection>
    ...
    <ScrollSection {...props} id="story.transformations.fallen-king">
      ...
      <div>
        <p></p>
        <p className="masonry">
          <img src="images/huntsman/bluebarb/5e7227c99c860c00d8b6944ef438a1f1.jpg" />
          <img src="images/huntsman/bluebarb/b506692b7ae9d41a2c734e84daa0b563.jpg" />
          <img src="images/huntsman/bluebarb/e454031d63ef49d60ab06fee78e1df2a.jpg" />
        </p>
      </div>
    </ScrollSection>
  </React.Fragment>
