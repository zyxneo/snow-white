...
const Section = props => (
  <React.Fragment>
    <ScrollSection {...props} id="symbol.symbols">
      <h2>Szimbólumok</h2>
      <div>
    ...
    <ScrollSection {...props} id="symbol.characters.snowwhite">
      <h3>Hófehérke</h3>
      <div>
    ...
    <ScrollSection {...props} id="symbol.characters.stepmother">
    ...
    <ScrollSection {...props} id="symbol.characters.king">
    ...
    <ScrollSection {...props} id="symbol.characters.prince">
      <h3>A herceg</h3>
      <div>
        <p>Milyennek képzeljük el?</p>
        <p className="masonry">
    ...
    <ScrollSection {...props} id="symbol.characters.huntsman">
      <h3>A vadász</h3>
      <div>
        <p>Milyennek képzeljük el?</p>
        <p className="masonry">
    ...
    <ScrollSection {...props} id="symbol.color.white">
      <h3>Fehér</h3>
      <div>
    ...
    <ScrollSection {...props} id="symbol.color.black">
      <h3>Fekete</h3>
      <div>
        <h4>Mi jut eszünkbe róla?</h4>
        <p className="masonry">
    ...
    <ScrollSection {...props} id="symbol.color.red">
      <h3>Vörös</h3>
      <div>
        <h4>Mi jut eszünkbe róla?</h4>
        <p className="masonry">
    ...
    <ScrollSection {...props} id="symbol.color.redInWhite">
    ...
    <ScrollSection {...props} id="symbol.color.redInBlack">
    ...
    <ScrollSection {...props} id="symbol.symbol.forest">
      <h3>Helyszín – Erdő</h3>
      <div>
        <h4>Mi jut eszünkbe róla?</h4>
        <p className="masonry">
    ...
    <ScrollSection {...props} id="symbol.symbol.heart">
      <h3>A szív</h3>
      <div>
        <h4>Mi jut eszünkbe róla?</h4>
    ...
    <ScrollSection {...props} id="symbol.symbol.home">
    ...
    <ScrollSection {...props} id="symbol.symbol.mirror">
      <h3>Tükör</h3>
      <div>
    ...
    <ScrollSection {...props} id="symbol.symbol.jail">
      <h3>A börtön</h3>
      <div>
