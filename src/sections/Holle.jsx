  ...
  <React.Fragment>
    <ScrollSection {...props} id="story.fairytales.holle">
      ...
      <div>
        ...
        <p>Mi is ez a kút. Ha jobban megvizsgáljuk és belenézünk, érdekes dolgot fogunk látni. Emlékszünk a mostohára aki a holdat figyelte éjjel, mint varázstükröt? Egy ugyanilyen varázstükröt láthatunk a kútban is. Az éj sötétjében világító holdkoroghoz hasonlóan csillan meg a kerek víztükör a kút sötét mélyében. És mit látunk még? Természetesen magunkat. Magunkat látjuk amint az alvilágból egy csőbe nézünk, és rácsodálkozunk felvilági tükörképünkre, valós önmagunkra. A kút így egy sötét cső, ami összeköt két világot. (Utas és holdvilág)</p>
        ...
        <p>Ennél egyértelműbben is tudnám mondani, de az már nagy illetlenség lenne. A mese szépsége, hogy finom szimbólumokkal dolgozik, melyek tágabb értelmüknél fogva képesek összkötni a kevésbé nyilvánvalóan összetartozó dolgokat is. A mese ugyanis csak most kezdődik...</p>

        <p>Még egy kis játék a Holle szóval: Hoehle németül, hole angolul barlangot, üreget, lyukat, udút, vermet jelent. A kút pontosan az, egy fekete üreg a föld mélysége felé. A kút egy út. Hol lel ilyen anyót az ember? Le kell menni az úton, le kell ereszkedni a kúton.</p>
        ...
        <p>Kapu és kút, a két elválaszó és összekötő szimbólum. Míg a kút egy sötét nedves cső, addig a kapunak lifegő szárnyai vannak... A lány ismét átkelhet, és ugyanott találja magát, ahol már volt, az életben. De ezúttal már nem a kis koszvadt, mostoha hamupipőke, hanem vagyonában él, jutalmul kapott aranyának köszönhetően. Ismerünk olyan városrészeket, ahol a Gazdagok és szépek élnek? Olyan helyeket a világbam amire azt mondják: oda születni kell? A lényka egy ilyen születésen van túl, vagyona nem e-világi, hanem túlvilági erők jutalma, előző életek munkája.</p>
        <p>Ezek után szomorú, hogy vannak olyanok is, akik lusták. Akiknek arany élete van, és nem veszik észre mások szenvedését. Ilyen volt a másik lány, aki nem mostoha volt, hanem édesgyermek. Mármint az anyjának az édesgyermeke, nem Holle anyónak. Mert hogy az előbbi lányka, a szorgos éppenhogy az volt, a Holle anyó legkedvesebb gyermeke. Nagyon ellentétesek voltak ők ketten, de mégis van valami fura hasonlóság. A szorgos leány a lustával helyet cserél a mese végén. A lusta lesz a koszos, a szorgos az aranyéletű... De vajon mira fogja őket ez a környezet motíválni? Tán csak nem ugyanarra? Elkezdődik egy újabb mese, hogy volt egy szegény szurkos leány, akinkek dolgozni kellett, és utálta az életét, és volt egy akinek arany élete volt, mert tetőtől talpig arany borította?...</p>


        <p>Nagyon érdekes, ahogy Holle anyó az elveszett orsót visszaadja a lánynak. Ezt is többféle módon lehet értelmezni, az egyik ilyen, hogy ezúttal ő kapta az orsót, és nem kislányként, hanem kisfiúként jött a világra, jelezve, hogy csak a lélek vándorol, nem a test.</p>


        <p>Ki is ez a Holle anyó? Értelmezésem és érvelésem igen ambivalens lesz. Két személyről van szó, és egyugyanazon személyről. A fekete istennőről, és a fehérről. A különböző jellemzők, az elkülönítésük egyszerű, de hogy miért mégis ugyanaz, az nehezebb. Szerintem azért lehet összevonni, mert nem tudjuk, melyikkel is állunk szemben, hiszen egy nem e-világi utazás során találkozunk vele, nincsenek emlékeink, tapasztalataink, csak sejtéseink. A jin-jang szimbólumhoz hasonlóan egymást feltételezik. Kéz a kézban járnak, és a legnagyobb ellenlábasok. Sőt, jó-rossz, fekete-fehér megítélésük szubjektív, az aktuális világnézet szerint, a szerint, melyik világból nézzük. Például ha épp meg vagyunk halva, és valahol felszabadul egy üres hely, az ebből a nézőpontból nagyon pozitív. De ha mi vagyunk az üres hely ex-tulajdonosai, az bezzeg mekkora szerencsétlenség.</p>
        ...
        <p>Miután a leány átkerül a túlvilágra, és találkozik annak úrnőjável, megijed a nagy fogaitól. Ismét a tibeti halottaskönyv halottaknak szóló tanácsai jutnak eszembe: Ne ijedjünk meg a vérivó és csontrágó szörnyektől. A lányka meghal és teste épp elenyész, a fekete istennő befogadja, estébe veszi. A fekete földbe kerül, alvadt fekete vérét, fekete bogarak, fekete gyökerek emésztik a fekete sötétségben. Azt is gondolhatnánk, ennél már nem is lehetne rosszabb. És valóban, kellemetlen helyzet ez, jogos az ijedelem. De maga az anyó kéri, ne féljen. Ez a fontos tanítítás a keresztény kultúrában is megjelenik: Ne féljetek. És valóban az ijedtség csak az első benyomás, a lány nem menekül, az anyó magához veszi.</p>
        ...
        <p>Az anyag nem vész el, csak átalakul. Az egyik test meghal, a másik megszületik. Az orsó pereg, készül a szál, szerveződnek a szövetek. Az univerum lassú forgásában a porszemnyi test tehetetlen az őt irányító erőkkel szemben. Ha lejár az ideje, a párkák elvágják élete fonalát, a fonalból mint érből kifolyik az éltető tűz, mint amikor a kútban mossák a véres szálat, kifeslik a piros. Az élet szálát fonó orsó végleg elkopik, nincs már meg az <b>Orsó</b> jöhet a kop<b>orsó</b>. Egy élet véget ér. A gonosz istennő felzabálja a dögöt, undorító, félelmetes módon. Persze ez a folyamat csak nekünk szörnyű, itt és most. Piroskát eszi épp a fekete farkas, még szép, hogy félelmetes. De az istennőnek azért kell ennie, hogy szülni tudjon. És valóban, a kútba esett lánynak holle anyó mellett új élete kezdődik.</p>
