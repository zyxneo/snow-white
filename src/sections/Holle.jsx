  ...
  <React.Fragment>
    <ScrollSection {...props} id="story.fairytales.holle">
      ...
      <div>
        ...
        <p>Még egy kis játék a Holle szóval: Hoehle németül, hole angolul barlangot, üreget, lyukat, udút, vermet jelent. A kút pontosan az, egy fekete üreg a föld mélysége felé, a Földanya nyílása. A kút egy út. Hol lel ilyen anyót az ember? Le kell menni az úton, le kell ereszkedni a kúton.</p>
        ...
        <p>Kapu és kút, a két elválaszó és összekötő szimbólum. Míg a kút egy sötét nedves cső, addig a kapunak lifegő szárnyai vannak... A lány ismét átkelhet, és ugyanott találja magát, ahol már volt, az életben. De ezúttal már nem a kis koszvadt, mostoha hamupipőke, hanem vagyonában él, jutalmul kapott aranyának köszönhetően. Ismerünk olyan városrészeket, ahol a Gazdagok és szépek élnek? Olyan helyeket a világban amire azt mondják: oda születni kell? A lényka egy ilyen születésen van túl, vagyona nem e-világi, hanem túlvilági erők jutalma, előző életek munkája.</p>
        <p>Ezek után szomorú, hogy vannak olyanok is, akik lusták. Akiknek arany élete van, és nem veszik észre mások szenvedését. Ilyen volt a lusta lány, aki nem mostoha, hanem édesgyermek volt. Mármint az anyjának az édesgyermeke, nem Holle anyónak. Mert a másik lányka, a szorgos majdhogynem az volt, Holle anyó legkedvesebb gyermeke. Nagyon ellentétesek voltak ők ketten, de mégis van valami fura hasonlóság. A szorgos leány a lustával helyet cserél a mese végén. A lusta lesz a koszos, a szorgos az aranyéletű... De vajon mira fogja őket ez a környezet motíválni? Tán csak nem ugyanarra? Elkezdődik egy újabb mese, hogy volt egy szegény szurkos leány, akinkek dolgozni kellett, és utálta az életét, és volt egy akinek arany élete volt, mert tetőtől talpig arany borította?...</p>
