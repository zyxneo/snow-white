...
const Section = props => (
  <ScrollSection {...props} id="story.storytelling">
    ...
    <h3>A bölcsek köve</h3>
    <div>
      <img src="/images/story/child-safety.jpg" className="ui medium left floated image" />
