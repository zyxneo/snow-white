...
const Section = props => (
  <ScrollSection {...props} id="story.storytelling">
    ...
    <div>
      <p>Az elemzés során - remélhetőleg - a magyar nyelv sajátos egyezéseire is kitérnék. Nem valamiféle nacionalizmus vezérel, pusztán úgy „magyarázom“ ahogy tudom. Nem Dorothea írja most ezt az elemzést. Neki francia felmenői voltak, így az ő meséi szimbólumainak gyökereit is a francia kultúrában keresik, a fennmaradó rész pedig a Grimmek révén a germanisztika tárgykörét képezi. Szerintem a mesék egyetemes tudást képviselnek. Isten óvjon engem attól, hogy a Holle anyó példájára, aki dunyhájából rázza a havat le a földre, felvessek valami Hóle anyó szerű hasonlatot. De most tényleg nem, kár lenne, így ha magyar nyelvi hasonlatokkal élek, tudjátok be annak, hogy csak a megértést próbálom segíteni. Állítólag a mese alapszerkezete világszerte fellelhető, s magam úgy vélem, kora felülmúlja a nemzetállamokét.</p>
    </div>
  </ScrollSection>
)
