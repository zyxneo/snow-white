  ...
  <React.Fragment>
    ...
    <ScrollSection {...props} id="story.storytelling.autopsie">
      ...
      <div>
        ...
        <p>Mielőtt kitérnék a mese történetére, javaslom annak elolvasását, mert mint kiderült, mindenkinek más-más emlékei vannak róla, és lényeges részletek hiányoznak ebből az emlékképből. Nagyon szomorú, hogy egyes óvónők sem tudják a mesét. Nem nevezem meg itt külön őket, elég baj az nekik, hogy szóvá kellett tegyem...</p>
      </div>
    </ScrollSection>
  </React.Fragment>
)
